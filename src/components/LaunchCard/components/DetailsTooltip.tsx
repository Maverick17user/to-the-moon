...
const DetailsTooltip = ({ details }: DetailsTooltipProps) => {
  return (
    <div className="absolute left-0 right-0 z-50 invisible mb-2 transition-all duration-300 translate-y-1 opacity-0 group-hover/details:translate-y-0 group-hover/details:opacity-100 group-hover/details:visible bottom-full">
